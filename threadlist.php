...
<body>
    ...
    $showalrt=false;
    $id=$_GET['$categary_id'];
    $threadlistid=$_GET['$thliid'];
    $categary_id=$_GET['$categary_id'];
    if (isset($threadlistid)) {
        $sql="DELETE FROM `threads` WHERE `thread_id`=$threadlistid";
                                    ...
                                    if($_SESSION['login']==true){
                                      ...
                                      if($th_user_email==$thloginemail){
                                          echo'<div class="threadlistbuttons">
                                              ...
                                              <a type="button" href="threadlist.php?$categary_id='.$id.'&$thliid='.$thread_id.'" class="btn btn-success my-2 my-sm-0 mr-sm-2 edit">
                                              Delete
                                              </a>
                                              </div>
                                          </div>';
