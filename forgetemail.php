<?php
                ...
                if ($method == 'POST'){
                    ...
                    if ($row['user_forget_question']==$forgetquestion && $row['user_forget_answer']==$forgetanswer) {
                        header("Location: /forrum/enterotp.php");
                    }
                }
    ?>
<!doctype html>
            ...
            <div class="cardbox">
                <div class="background mb-2 p-4">
                        <form action="'.$_SERVER["REQUEST_URI"].'" method="post">   
                            ...
                            <div class="form-group">
                                <input type="checkbox" id="forgetbox" name="forgetbox" value="Bike" required>
