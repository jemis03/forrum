...
if (isset($contdid)) {
    $contdid=$_GET['$contdid'];
    $sql="DELETE FROM `contacts` WHERE `contact_id`=$contdid";
                                ...
                                <tbody>';
                                    ...
                                    while ($row= mysqli_fetch_assoc($result)) {
                                        ...
                                        <td><div class="deletebutton">
                                            <a type="button" href="contact.php?$contdid='.$contact_id.'" class="btn btn-primary my-2 my-sm-0 mr-sm-2 edit">
                                            Delete
                                            </a>
                                          </div></td>';
...
if ($contact_success=="true") {
    echo '
            ...
            Swal.fire({
                title: "Success",
                text: "Your user comment is deleted successfully",
                icon: "success",
