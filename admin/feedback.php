...
if (isset($feedid)) {
    $feedid=$_GET['$feedid'];
    $sql="DELETE FROM `feedback` WHERE `feedback_sno`=$feedid";
                            ...
                            <table id="datatablesSimple" class="table">
                                ...
                                <tbody>';
                                    ...
                                    while ($row= mysqli_fetch_assoc($result)) {
                                        ...
                                        $feedback_fname= $row['feedback_fname'];
                                        $feedback_lname= $row['feedback_lname'];
                                        ...
                                        <tr>
                                        <td>'.$feedbackcount.'</td>
                                        <td>'.$feedback_fname.'</td>
                                        <td>'.$feedback_lname.'</td>
                                        <td>'.$feedback_email.'</td>
                                        <td>'.$feedback_rating.'</td>
                                        <td>'.$feedback_time.'</td>
                                        <td><div class="deletebutton">
                                            <a type="button" href="feedback.php?$feedid='.$feedback_sno.'" class="btn btn-primary my-2 my-sm-0 mr-sm-2 edit">
                                            Delete
                                            </a>
                                          </div></td>';
...
if ($feedback_success=="true") {
    echo '
            ...
            Swal.fire({
                title: "Success",
                text: "This feedback of user is deleted successfully",
                icon: "success",
